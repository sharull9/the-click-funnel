...
const capabilityShowcases = [
  {
    ...
    description:
      "See how we transform complex business concepts into visually compelling narratives that captivate investors.",
    service: "Pitch Deck",
    outcome: "Investor-ready in 2 weeks",
    image:
      "https://i.pinimg.com/originals/ed/97/b0/ed97b0030dcc71eafaf77b70cd1b0c3c.gif",
  },
  {
    id: 2,
    title: "Funding Strategy Development",
    description:
      "Our systematic approach to identifying and connecting with the right funding sources for your business stage.",
    service: "Fund Raising",
    outcome: "Targeted investor matches",
    image:
      "https://i.pinimg.com/originals/e5/b3/49/e5b349c0aeecefbf385a8ea327491313.gif",
  },
  {
    id: 3,
    title: "Business Plan Structuring",
    description:
      "How we help founders articulate their vision into a comprehensive, bankable business strategy document.",
    service: "Business Plan",
    outcome: "Clear roadmap to success",
    image:
      "https://i.pinimg.com/originals/8b/d4/0d/8bd40db25399dca2dc5a69605f18cec3.gif",
  },
];
      ...
      <div className="relative w-[90%] sm:w-[85%] md:w-[95%] max-w-8xl mx-auto">
        ...
        <div className="text-left mb-8 sm:mb-12" ref={titleRef}>
          ...
          >
            ...
            >
              While we're building our portfolio, here's how we apply industry
...
function CaseStudiesCard({ showcase, index }) {
