...
const industries = [
  {
    name: "E-Commerce",
    examples:
      "Online marketplaces, price comparison, online grocery, B2B platforms",
  ...
  },
  {
    name: "Sports Tech",
    examples:
      "Fantasy sports, gaming, casinos, sports tech, gym, diet consultation",
    icon: <Trophy className="w-8 h-8 text-green-400" />,
  },
  {
    name: "Non-Profit",
    examples: "Non-profit organization grants, crowdfunding platforms",
    icon: <HandHeart className="w-8 h-8 text-green-400" />,
  },
  {
  ...
  },
  {
    ...
    examples:
      "Real estate portals, construction marketplaces, construction companies",
  ...
  },
  {
    name: "Beauty & Fashion",
    examples:
      "Online apparel portals, T-shirt brands, men's wear, accessories, gifting",
  ...
  },
  {
    ...
    examples:
      "Recruitment portals, blue-collar job portals, freelancing platforms",
