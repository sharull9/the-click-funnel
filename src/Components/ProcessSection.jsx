...
const steps = [
  {
    ...
    description:
      "Share your raw content, notes, or existing slides with our team.",
  },
  {
    id: 2,
      ...
      <div className="relative w-[90%] sm:w-[85%] md:w-[95%] max-w-8xl mx-auto">
        ...
        >
          <p className="text-md sm:text-lg text-gray-700 max-w-3xl">
            Wondering how we turn around high-quality presentations so quickly?
            Our secret lies in a proven, streamlined process backed by expert
            designers at every step. From concept to final polish, we ensure
            your corporate presentation isn't just well-designed—it powerfully
            reflects your brand's voice, values, and vision.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, index) => (
            <Steps step={step} index={index} key={step.id} />
          ))}
        </div>
        ...
        >
          <Link to="#contactus" text="Get Professional Design Services" />
